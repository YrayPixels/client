							...
							<div class="card">
								...
								<div class="card-body p-0">
									...
									<div class="card-px text py-10 my-10">
										...
										<!--end::Description-->
										<!--begin::Action-->
										<a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer"> Corporate cleints</a>
										<a href="#" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Dealers</a>
										<!--end::Action-->
									</div>
									<!--end::Wrapper-->
									<!--begin::Illustration-->
