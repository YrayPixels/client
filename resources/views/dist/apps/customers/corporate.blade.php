            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="card-px text py-10 my-10">
                        ...
                        <!--end::Description-->
                        <!--begin::Action-->
                        <a class="btn btn-primary" data-bs-target="#kt_modal_add_customer" data-bs-toggle="modal"
                            href="#"> Corporate cleints</a>
            ...
            <div aria-hidden="true" class="modal fade" id="kt_modal_add_customer" tabindex="-1">
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        <!--begin::Form-->
                        <form action="#" class="form" data-kt-redirect="../../demo9/dist/apps/customers/list.html"
                            ...
                            <div class="modal-body py-10 px-lg-17">
                                ...
                                <div class="scroll-y me-n7 pe-7" data-kt-scroll-activate="{default: false, lg: true}"
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" name="name" placeholder=""
                                            type="text" value="Sean Bean" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" name="email" placeholder=""
                                            type="email" value="sean@dellito.com" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="fv-row mb-15">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" name="description" placeholder=""
                                            type="text" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div aria-controls="kt_customer_view_details" aria-expanded="false"
                                        ...
                                        href="#kt_modal_add_customer_billing_info" role="button">Shipping Information
                                    ...
                                    <div class="collapse show" id="kt_modal_add_customer_billing_info">
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input class="form-control form-control-solid" name="address1" placeholder=""
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input class="form-control form-control-solid" name="address2" placeholder=""
                                                value="" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input class="form-control form-control-solid" name="city" placeholder=""
                                                value="Melbourne" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="row g-9 mb-7">
                                            ...
                                            <div class="col-md-6 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input class="form-control form-control-solid" name="state"
                                            ...
                                            <div class="col-md-6 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input class="form-control form-control-solid" name="postcode"
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <select aria-label="Select a Country"
                                                class="form-select form-select-solid fw-bolder" data-control="select2"
                                                data-dropdown-parent="#kt_modal_add_customer"
                                                data-placeholder="Select a Country..." name="country">
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <label class="form-check form-switch form-check-custom form-check-solid">
                                                    ...
                                                    <input checked="checked" class="form-check-input"
                                                        id="kt_modal_add_customer_billing" name="billing" type="checkbox"
                                                        value="1" />
                                                    <!--end::Input-->
                                                    <!--begin::Label-->
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <input class="form-control form-control-lg form-control-solid"
                                                name="dbname" placeholder="" type="text" value="master_db" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
        ...
        <div class="modal-dialog mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex justify-content-end">
                    ...
                    <!-- <button class="btn btn-primary" data-bs-dismiss="modal" id="kt_modal_select_location_button" type="button">Apply</button> -->
                </div>
                <!--end::Modal footer-->
            </div>
            <!--end::Modal content-->
