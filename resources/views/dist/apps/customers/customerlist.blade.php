						...
						<div class="header-container container-xxl">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
								...
								<h1 class="d-flex flex-column text-dark fw-bolder my-1">
									<span class="text-white fs-1">ADMIN DASHNOARD</span>
								</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-line fw-bold fs-7 my-1">
									...
									<li class="breadcrumb-item text-gray-400">customer List</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
							...
							<div class="card">
								...
								<div class="card-header border-0 pt-6">
									...
									<div class="card-title">
										...
										<a href="{{url('dealers')}}" class="btn  btn-light btn-active-light-primary">Customer List
                                         </a></div>
                                         <div class="col-md-6" style="margin-left: 0px;">
										<a href="{{url('invoice')}}" class="btn  btn-light btn-active-light-primary">Invoice List
                                         </a></div>
									</div>
									<!--begin::Card title-->
									<!--begin::Card toolbar-->
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
										...
										<tbody class="fw-bold text-gray-600">
											...
											<tr>
												...
												<!--begin::Name=-->
												<td>
													<a class="text-gray-800 text-hover-primary mb-1" href="{{url('overv',$data->id)}}">
													{{$data->user_code}}
												</a>
												</td>
												<td>
												...
												<!--begin::Action=-->
												<td class="text-end">
													<a href="{{url('overv',$data->id)}}" class="btn btn-sm btn-light btn-active-light-primary" data-kt-menu-trigger="" data-kt-menu-placement="bottom-end">Actions
