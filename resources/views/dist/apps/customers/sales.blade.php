						...
						<div id="kt_aside_menu_wrapper" class="w-100 hover-scroll-overlay-y scroll-ps d-flex" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu" data-kt-scroll-offset="0">
							<div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-icon-gray-400 menu-arrow-gray-400 fw-bold fs-6" data-kt-menu="true">
								<div class="menu-item py-3">
									<a class="menu-link" href="{{url('/')}}" title="Dashboard" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
						...
						<div class="header-container container-xxl">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
								...
								<h1 class="d-flex flex-column text-dark fw-bolder my-1">
									<span class="text-white fs-1">SALES DASHBOARD</span>
								</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-line fw-bold fs-7 my-1">
									...
									<li class="breadcrumb-item text-gray-400">DEALERS</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
...
@endif</div>
										...
										<!--end::Description-->
										<!--begin::Action-->
										<a href="{{url('dealers')}}" class="btn btn-primary"  >Search Coporate List</a>

										<a href="#" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#ckt_modal_add_customer">Add Corporate cleints</a>
										<!-- DEALLER -->
										<a href="#" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Dealers cleints</a>
										<!--end::Action-->
									</div>
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
										...
										<tbody class="fw-bold text-gray-600">
											...
											<tr>
												...
												<!--begin::Action=-->
												<td class="text-end">
													<a href="{{url('/buy',$data->id)}}" class="btn btn-sm btn-light btn-active-light-primary" >Buy Items
													</a>
													<!--begin::Menu-->
					...
					<!--end::Content-->
							...
							<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
								...
								<div class="modal-dialog modal-dialog-centered mw-650px">
									...
									<div class="modal-content">
										<!--begin::Form-->
										<form  enctype="multipart/form-data" class="form" action="{{url('/dstore')}}" id="kt_modal_add_customer_form" method="Post">
											 @csrf
											...
											<div class="modal-body py-10 px-lg-17">
												...
												<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
													...
													<input class="form-control form-control-lg form-control-solid" type="hidden" value="DC{{$un}}" name="user_code" />

													<input class="form-control form-control-lg form-control-solid" type="text"  value="Dealer" name="user_type" hidden />
							<div class="row fv-row mb-7">
								<!--begin::Col-->
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">First Name</label>
									<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="first_name" autocomplete="" required="" />
								</div>
								<!--end::Col-->
								<!--begin::Col-->
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">Last Name</label>
									<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="last_name" autocomplete="" required="" />
								</div>
								<!--end::Col-->
							</div>
							...
							<div class="row fv-row mb-7">
								...
								<div class="col-xl-6">
									...
									<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="state" autocomplete="" required="" />
								</div>
								<!--end::Col-->
								<!--begin::Col-->
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">{{_('Local Gov')}}</label>
									<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="local_government" autocomplete="" required="" />
								</div>
								<!--end::Col-->
							</div>
							...
							<div class="row fv-row mb-7">
								...
								<div class="col-xl-6">
									...
									<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="address" autocomplete="" required="" />
								</div>
								<!--end::Col-->
								<!--begin::Col-->
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">{{_('Land Mark')}}</label>
									<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="landmark" autocomplete="" required="" />
								</div>
								<!--end::Col-->
							</div>
							<div class="row fv-row mb-7">
								...
								<div class="col-xl-6">
									...
									<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="phone_number" autocomplete="" required="" />
								</div>
								<!--end::Col-->
								<!--begin::Col-->
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">{{_('Email')}}</label>
									<input class="form-control form-control-lg form-control-solid" type="email" placeholder="" name="email" autocomplete="" required="" />
								</div>
							...
							<!-- <center>
								<button type="button" id="kt_modal_select_location_button" class="btn btn-primary" data-bs-dismiss="modal">Save process
								</button>
							</center> -->
													<!--end::Input group-->
													<!--begin::Input group-->
													...
													<div class="fw-bolder fs-3 rotate collapsible mb-7" data-bs-toggle="collapse" href="#kt_modal_add_customer_billing_info" role="button" aria-expanded="false" aria-controls="kt_customer_view_details">Corporate Registration Details
													...
													<div id="kt_modal_add_customer_billing_info" class="collapse show">
														...
														<div class="d-flex flex-column mb-7 fv-row">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input class="form-control form-control-solid" placeholder="" type="text"  name="store_name" value="101, Collins Street" />
															<!--end::Input-->
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
														<div class="d-flex flex-column mb-7 fv-row">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input class="form-control form-control-solid" placeholder="" type="text" name="store_address" value="" />
															<!--end::Input-->
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
														<div class="d-flex flex-column mb-7 fv-row">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input type="file" class="form-control form-control-solid" placeholder="" name="idcard" value="Melbourne" />
															<!--end::Input-->
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
														<div class="row g-9 mb-7">
															...
															<div class="col-md-6 fv-row">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<input class="form-control form-control-solid" placeholder="2299833" name="bank_number"/>
																<!--end::Input-->
															</div>
															<!--end::Col-->
															<!--begin::Col-->
															<div class="col-md-6 fv-row">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<input class="form-control form-control-solid" placeholder="DANIEL" name="bank_name" />
																<!--end::Input-->
															</div><div class="col-md-6 fv-row">
																<!--begin::Label-->
																<label class="required fs-6 fw-bold mb-2">BANK</label>
																<!--end::Label-->
																<!--begin::Input-->
																<input class="form-control form-control-solid" placeholder="GTBANK" name="bank" />
																<!--end::Input-->
															</div>
															<!--end::Col-->
														</div>
							...
							<!-- Corporate model -->
							<!--begin::Modal - Customers - Add-->
							<div class="modal fade" id="ckt_modal_add_customer" tabindex="-1" aria-hidden="true">
								<!--begin::Modal dialog-->
								<div class="modal-dialog modal-dialog-centered mw-650px">
									<!--begin::Modal content-->
									<div class="modal-content">
										<!--begin::Form-->
											...
											<form  enctype="multipart/form-data" class="form" action="{{url('/cstore')}}" id="ckt_modal_add_customer_form" method="Post">
											 @csrf
											...
											<div class="modal-header" id="ckt_modal_add_customer_header">
												...
												<!--end::Modal title-->
												<!--begin::Close-->
												<div id="ckt_modal_add_customer_close" class="btn btn-icon btn-sm btn-active-icon-primary">
													<!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
													<span class="svg-icon svg-icon-1">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
															<rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="black" />
											...
											<div class="modal-body py-10 px-lg-17">
											<!--begin::Scroll-->
												<div class="scroll-y me-n7 pe-7" id="ckt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#ckt_modal_add_customer_header" data-kt-scroll-wrappers="#ckt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
													<!--begin::Input group-->


									<input class="form-control form-control-lg form-control-solid" type="hidden" value="CC{{$un}}" name="user_code" autocomplete="" required="" />
									<input class="form-control form-control-lg form-control-solid" type="text" hidden value="Corporate" name="user_type"/>

							<div class="row fv-row mb-7">
								<!--begin::Col-->
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">First Name</label>
									<input class="form-control form-control-lg form-control-solid" type="text" placeholder="Daniel" name="first_name" autocomplete="" required="" />
								</div>
								<!--end::Col-->
								<!--begin::Col-->
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">Last Name</label>
									<input class="form-control form-control-lg form-control-solid" type="text" placeholder="Sameul" name="last_name" autocomplete="" required="" />
								</div>
								<!--end::Col-->
							</div>
							...
							<div class="row fv-row mb-7">
								...
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">{{_('State')}}</label>
									<input class="form-control form-control-lg form-control-solid" type="text" placeholder="Abuja" name="state" autocomplete="" required="" />
								</div>
								<!--end::Col-->
								<!--begin::Col-->
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">{{_('Local Gov')}}</label>
									<input class="form-control form-control-lg form-control-solid" type="text" placeholder="Area 1" name="local_government" autocomplete="" required="" />
								</div>
								<!--end::Col-->
							</div>
							...
							<div class="row fv-row mb-7">
								...
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">{{_('Address')}}</label>
									<input class="form-control form-control-lg form-control-solid" type="text" placeholder=" behind firstbank" name="address" autocomplete="" required="" />
								</div>
								<!--end::Col-->
								<!--begin::Col-->
								<div class="col-xl-6">
							...
							<div class="row fv-row mb-7">
								...
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">{{_('Phone No')}}</label>
									<input class="form-control form-control-lg form-control-solid" type="text" placeholder="08000000" name="phone_number" autocomplete="" required="" />
								</div>
								<!--end::Col-->
								<!--begin::Col-->
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">{{_('Email')}}</label>
									<input class="form-control form-control-lg form-control-solid" type="email" placeholder="em@gmail.com" name="email" autocomplete="" required="" />
								</div>
							</div>
								<!-- profile image -->
							<div class="row fv-row mb-7">
								...
								<div class="col-xl-12">
									...
									<input class="form-control form-control-lg form-control-solid" type="file" placeholder="" name="profile_image" autocomplete="" />
								</div>
						...
						<!-- 	<center>
								<button type="button" id="kt_modal_select_location_button" class="btn btn-primary" data-bs-dismiss="modal">Save process
													...
													<!--end::Input group-->
													<!--begin::Billing toggle-->
												<div class="fw-bolder fs-3 rotate collapsible mb-7" data-bs-toggle="collapse" href="#ckt_modal_add_customer_billing_info" role="button" aria-expanded="false" aria-controls="kt_customer_view_details">Corporate Registration Details
													<span class="ms-2 rotate-180">
														<!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
														<span class="svg-icon svg-icon-3">
															<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
													...
													<!--end::Billing toggle-->
													<!--begin::Billing form-->
													<div id="ckt_modal_add_customer_billing_info" class="collapse show">
														<!--begin::Input group-->
														<div class="d-flex flex-column mb-7 fv-row">
															<!--begin::Label-->
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input class="form-control form-control-solid" placeholder="Market square" name="caddress" value="101, Collins Street" />
															<!--end::Input-->
														</div>
														...
														<div class="d-flex flex-column mb-7 fv-row">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input class="form-control form-control-solid" placeholder="1234567753" name="tin" value="" />
															<!--end::Input-->
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
														<div class="d-flex flex-column mb-7 fv-row">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input type="file" class="form-control form-control-solid" placeholder="" name="cac" value="Melbourne" />
															<!--end::Input-->
											...
											<div class="modal-footer flex-center">
												<!--begin::Button-->
												<button type="reset" id="ckt_modal_add_customer_cancel" class="btn btn-light me-3">Discard</button>
												<!--end::Button-->
												<!--begin::Button-->
												<button type="submit" id="ckt_modal_add_customer_submit" class="btn btn-primary">
													<span class="indicator-label">Submit</span>
													<span class="indicator-progress">Please wait...
													<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
												</button>
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-xxl d-flex flex-column flex-md-row flex-stack">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="#" target="" class="text-muted text-hover-primary fw-bold me-2 fs-6">Keenthemes</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
							<ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
								...
								<li class="menu-item">
									<a href="#/support" target="" class="menu-link px-2">Support</a>
								</li>
								<li class="menu-item">
									<a href="https://1.envato.market/EA4JP" target="" class="menu-link px-2">Purchase</a>
								</li>
							</ul>
							<!--end::Menu-->
						</div>
						...
						<div class="mb-0">
							...
							<div class="mb-7">
								<div class="d-flex flex-stack">
									...
									<a href="https://themeforest.net/licenses/standard" class="fw-bold" target="">License FAQs</a>
								</div>
							</div>
							<!--end::Header-->
							<!--begin::License-->
							...
							<div class="rounded border border-dashed border-gray-300 py-4 px-6 mb-5">
								<div class="d-flex flex-stack">
									...
									<div class="text-nowrap">
										<a href="#/contact/" class="btn btn-sm btn-success" target="">Contact Us</a>
									</div>
								</div>
							</div>
							<!--end::License-->
