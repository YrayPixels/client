						...
						<div class="header-container container-xxl">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
								...
								<h1 class="d-flex flex-column text-dark fw-bolder my-1">
									<span class="text-white fs-1">Getting Started</span>
								</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-line fw-bold fs-7 my-1">
									...
									<li class="breadcrumb-item text-gray-400">Getting Started</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
							...
							<div class="d-flex align-items-center flex-wrap">
								...
								<div class="header-search py-3 py-lg-0">
									...
									<div id="kt_header_search" class="d-flex align-items-center" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-start" data-kt-menu-flip="bottom">
										<!--begin::Form-->
										<form data-kt-search-element="form" class="w-100 position-relative me-3" autocomplete="" required="">
...
@endif</div>
										...
										<!--end::Description-->
										<!--begin::Action-->
										<a href="{{url('dealers')}}" class="btn btn-primary"  >View List</a>

										<a href="#" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#ckt_modal_add_customer"> Corporate cleints</a>
										<!-- DEALLER -->
										<a href="#" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Dealers cleints</a>
										<!--end::Action-->
									</div>
										...
										<form  enctype="multipart/form-data" class="form" action="{{url('/dstore')}}" id="kt_modal_add_customer_form" method="Post">
											...
											<div class="modal-body py-10 px-lg-17">
												...
												<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
													...
													<input class="form-control form-control-lg form-control-solid" type="hidden" value="{{__('DC')}}{{date('yMHs')}}" name="user_code" autocomplete="" required="" />
							...
							<div class="modal fade" id="ckt_modal_add_customer" tabindex="-1" aria-hidden="true">
								...
								<div class="modal-dialog modal-dialog-centered mw-650px">
									...
									<input class="form-control form-control-lg form-control-solid" type="hidden" value="{{__('CC')}}{{date('yMHs')}}" name="user_code" autocomplete="" required="" />
												...
												<div class="fw-bolder fs-3 rotate collapsible mb-7" data-bs-toggle="collapse" href="#ckt_modal_add_customer_billing_info" role="button" aria-expanded="false" aria-controls="kt_customer_view_details">Corporate Registration Details
													...
													<div id="ckt_modal_add_customer_billing_info" class="collapse show">
														...
														<div class="d-flex flex-column mb-7 fv-row">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input class="form-control form-control-solid" placeholder="" name="caddress" value="101, Collins Street" />
															<!--end::Input-->
														</div>
														...
														<div class="d-flex flex-column mb-7 fv-row">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input class="form-control form-control-solid" placeholder="" name="tin" value="" />
															<!--end::Input-->
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
