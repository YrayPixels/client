						...
						<div class="header-container container-xxl">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
								...
								<ul class="breadcrumb breadcrumb-line fw-bold fs-7 my-1">
									...
									<li class="breadcrumb-item text-gray-400">Invoice List</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
										...
										<tbody class="fw-bold text-gray-600">
											...
											<tr>
												...
												<!--begin::Name=-->
												<td>
													<a class="text-gray-800 text-hover-primary mb-1" href="{{url('/approveinvoice',$data->user_id)}}">
													{{$data->invoice}}
												</a>
												</td>
												<td>
												...
												<td>
													...
													@else
													<i class="btn btn-danger" >Due Date</i>
												...
												<!--begin::Action=-->
												<td class="text-end">
													<a href="{{url('/approveinvoice',$data->user_id)}}" class="btn btn-sm btn-light btn-active-light-primary" data-kt-menu-trigger="" data-kt-menu-placement="bottom-end">Actions
