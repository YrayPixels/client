@extends('layouts.newapp', ['title' => 'View Invoice'])
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="text-gray-800 text-hover-primary mb-1"
                                            href="{{ url('/approveinvoice', $data->user_id) }}">
                                            {{ $data->invoice }}
                                        </a>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        <a class="btn btn-sm btn-light btn-active-light-primary"
                                            ...
                                            href="{{ url('/approveinvoice', $data->user_id) }}">Actions
    ...
    <div class="scrolltop" data-kt-scrolltop="true" id="kt_scrolltop">
        ...
        <span class="svg-icon">
            <svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                <rect fill="black" height="2" opacity="0.5" rx="1" transform="rotate(90 13 6)" width="13"
                    x="13" y="6" />
                <path
