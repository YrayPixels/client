								...
								<div class="card-body py-20">
									...
									<div class="mw-lg-950px mx-auto w-100">
										...
										<div class="d-flex justify-content-between flex-column flex-sm-row mb-19">
											<h4 class="fw-boldest text-gray-800 fs-2qx pe-2 pb-7">INVOICE #{{date("ydhs") }} </h4>
											<!--end::Logo-->
											...
											<div class="d-flex justify-content-between flex-column flex-md-row">
												...
												<div class="text-end pt-10">
													...
													<form action="{{url('/invoice')}}" method="POST">
														@csrf
													<div class="text-muted fw-bold">Taxes included<input class="form-control " type="number" name="added_price" value="{{$sumTotal}}"></div>
													<!--end::Total Amount-->
										...
										<div class="d-flex flex-stack flex-wrap mt-lg-16 pt-6">
											...
											<div class="my-1 me-1">
													...
													<input type="" hidden name="buyer_name" value="{{$dealer->first_name}} {{$dealer->last_name}}">
													<input type="" hidden name="user_code" value="{{$dealer->user_code}}">
