						...
						<div class="header-container container-xxl">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
								...
								<h1 class="d-flex flex-column text-dark fw-bolder my-1">
									<span class="text-white fs-1">Dealer  Details</span>
								</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-line fw-bold fs-7 my-1">
									...
									<li class="breadcrumb-item text-gray-400">Overview</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
						...
						<div class="container-xxl" id="kt_content_container">
							...
							<div class="card mb-5 mb-xl-10">
								...
								<div class="col-xl-6">
									...
									<input class="form-control form-control-lg form-control-solid" type="text" value="{{$data->first_name}}"  disabled />
								</div>
								<!--end::Col-->
								<!--begin::Col-->
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-4">Last Name</label>
									<input class="form-control form-control-lg form-control-solid" type="text" value="{{$data->last_name}}"  disabled />
								</div>
								<!--end::Col-->
							</div><div class="row fv-row mb-7">
								<!--begin::Col-->
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-4">State</label>
									<input class="form-control form-control-lg form-control-solid" type="text" value="{{$data->state}}"  disabled />
								</div>
								<!--end::Col-->
								<!--begin::Col-->
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-4">Local Gov</label>
									<input class="form-control form-control-lg form-control-solid" type="text" value="{{$data->local_government}}"  disabled />
								</div>
								<!--end::Col-->
							</div>
							<div class="row fv-row mb-7">
								...
								<div class="col-xl-6">
									...
									<input class="form-control form-control-lg form-control-solid" type="text" value="{{$data->address}}"  disabled />
								</div>
								<!--end::Col-->
								<!--begin::Col-->
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-4">Land mark</label>
									<input class="form-control form-control-lg form-control-solid" type="text" value="{{$data->landmark}}"  disabled />
								</div>
								<!--end::Col-->
							</div><div class="row fv-row mb-7">
								<!--begin::Col-->
								<div class="col-xl-6">
									...
									<input class="form-control form-control-lg form-control-solid" type="text" value="{{$data->phone_number}}"  disabled />
								</div>
								<!--end::Col-->
								<!--begin::Col-->
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-4">Email Address</label>
									<input class="form-control form-control-lg form-control-solid" type="text" value="{{$data->email}}"  disabled />
								</div>
								<!--end::Col-->
							</div>
							<!--endbegin::Details-->
									...
									<div class="d-flex flex-wrap flex-sm-nowrap mb-3">
										...
										<div class="me-7 mb-4">
											<div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
													<img src="{{url('/images/',$data->profile_image)}}" alt="image" />
									...
									<input class="form-control form-control-lg form-control-solid" type="text" value="{{$data->user_code}}"  disabled />
								</div>		
													</div>
													...
													<i class="btn btn-warning" >Suspend</i>
														
													@elseif($data->active=='1')
													<i class="btn btn-success" >Approve</i>
													@else
													<i class="btn btn-danger" >Deactivated</i>
							...
							<div class="card mb mb-xl-10" id="kt_profile_details_view">
								...
								<div class="card-body p-9">
									...
									<div class="row mb-7">
										...
										<!--begin::Col-->
										<div class="col-lg-8">
											<span class="fw-bolder fs-6 text-gray-800"><a href="{{url('edocm/',$data->idcard)}}" target="_blank"> {{$data->idcard}}</a> 
									...
									<div class="row mb-7">
										...
										<!--begin::Col-->
										<div class="col-lg-8 fv-row">
											<span class="fw-bolder fs-6 text-gray-800"><a href="{{url('docm/',$data->idcard)}}" target="_blank"> {{$data->idcard}}</a> 
									...
									<div class="row mb-7">
										...
										<!--begin::Col-->
										<div class="col-lg-8">
											<span class="fw-bolder fs-6 text-gray-800">{{$data->bank_number}}</span>
										</div>
										<!--end::Col-->
									</div>
									...
									<div class="row mb-7">
										...
										<!--begin::Col-->
										<div class="col-lg-8">
											<span class="fw-bolder fs-6 text-gray-800">{{$data->bank}}</span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Input group-->
									...
									<!--begin::Action-->
									<a href="{{url('approve',$data->id)}}" class="btn btn-success align-self-center">APPROVED </a>
									<a href="{{url('suspend',$data->id)}}" class="btn btn-warning align-self-center">SUSPEND </a>
									<a href="{{url('de_activate',$data->id)}}" class="btn btn-danger align-self-center">DE-ACTIVATE</a>
									<!--end::Action-->
								</div>
